                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      RaisedButton(
                        ...
                        onPressed: (){
                          Firestore.instance.collection('Category').document('FoodCategory').collection('Drink')
...
*/
  ...
  getDrinks(FoodNotifier foodNotifier) async{

    QuerySnapshot snapshot = await Firestore.instance.collection('Category').document('FoodCategory').collection('Drink').getDocuments();

    List<Food> _foodList = [];
    snapshot.documents.forEach((document){
      if(document.data['Quantity'] > 0) {
        Food drink = Food.fromMap(document.data);
        _foodList.add(drink);
