                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      RaisedButton(
                        ...
                        onPressed: (){
                          Firestore.instance.collection('Category').document('FoodCategory').collection('Instant')
...
*/
  ...
  getInstants(FoodNotifier foodNotifier) async{

    QuerySnapshot snapshot = await Firestore.instance.collection('Category').document('FoodCategory').collection('Instant').getDocuments();

    List<Food> _foodList = [];
    snapshot.documents.forEach((document){
      if(document.data['Quantity'] > 0) {
        Food instants = Food.fromMap(document.data);
        _foodList.add(instants);
