                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      RaisedButton(
                        ...
                        onPressed: (){
                          Firestore.instance.collection('Category').document('FoodCategory').collection('Canned')
...
*/
  ...
  getCanned(FoodNotifier foodNotifier) async{
    ...
    QuerySnapshot snapshot = await Firestore.instance.collection('Category').document('FoodCategory').collection('Canned').getDocuments();

    List<Food> _foodList = [];
    snapshot.documents.forEach((document){
      if(document.data['Quantity'] > 0) {
        Food canned = Food.fromMap(document.data);
        _foodList.add(canned);
