...
getDessert(FoodNotifier foodNotifier) async{

  QuerySnapshot snapshot = await Firestore.instance.collection('Category').document('DessertCategory').collection('Dessert').getDocuments();
