                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      RaisedButton(
                        ...
                        onPressed: (){
                          Firestore.instance.collection('Category').document('FoodCategory').collection('Frozen')
...
*/
  ...
  getFruits(FoodNotifier foodNotifier) async{
    ...
    QuerySnapshot snapshot = await Firestore.instance.collection('Category').document('FoodCategory').collection('Frozen').getDocuments();
