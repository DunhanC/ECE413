                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      RaisedButton(
                        ...
                        onPressed: (){
                          Firestore.instance.collection('Category').document('FoodCategory').collection('Seafood')
...
*/
  ...
  getSeafood(FoodNotifier foodNotifier) async{
    ...
    QuerySnapshot snapshot = await Firestore.instance.collection('Category').document('FoodCategory').collection('Seafood').getDocuments();

    List<Food> _foodList = [];
    snapshot.documents.forEach((document){
      if(document.data['Quantity'] > 0) {
        Food seafood = Food.fromMap(document.data);
        _foodList.add(seafood);
